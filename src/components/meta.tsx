...
export const Meta = {
  ...
  description: 'Jarrod Semmens Window Cleaning is a locally owned and operated business that provides professional window cleaning services to residential and commercial customers in Tahoe City, CA.',
